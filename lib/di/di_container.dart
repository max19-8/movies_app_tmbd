...
import 'package:movies_app_tmbd/ui/widgets/movie_detail_screen/movie_detail_widget.dart';
...
class _DiContainer {
  ...
  NewModel _makeMovieDetailsViewModel(int movieId) => NewModel(movieId,
