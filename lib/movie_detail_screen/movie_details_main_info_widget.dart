...
import 'package:movies_app_tmbd/widgets/custom_widgets/radial_percent_widget.dart';
...
class _TopPosterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final posterData = context.select((MovieDetailsViewModel model) => model.data.posterData);
        ...
        Positioned(
          ...
          child: ClipRRect(
            ...
            child: posterPath != null ? Image.network(
                ImageDownloader.imageUrl(posterPath)) : const SizedBox.shrink(),
          ),
        ),
        Positioned(
          top: 5,
...
class _MovieNameWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final data = context.select((MovieDetailsViewModel model) => model.data.movieNameData);
    return Center(
      child: RichText(
...
class _ScoreWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final scoreData = context.select((MovieDetailsViewModel model) => model.data.scoreData);
...
class _SummaryWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final summary = context.select((MovieDetailsViewModel model) => model.data.summary);
    return ColoredBox(
...
class _DescriptionWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final overview = context.select((MovieDetailsViewModel model) => model.data.overview);
    return Padding(
...
class _PeopleWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var crew = context.select(( MovieDetailsViewModel model ) => model.data.peopleData);
...
class _PeopleWidgetRow extends StatelessWidget {
  final List<MovieDetailsMoviePeoplesData> employees;
...
class _PeopleWidgetRowItem extends StatelessWidget {
  final MovieDetailsMoviePeoplesData employee;
