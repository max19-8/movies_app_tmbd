...
class TvShowDetailsMainCastWidget extends StatelessWidget {
  const TvShowDetailsMainCastWidget({Key? key}) : super(key: key);
...
class _ActorListWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final data = context.select(( TvShowDetailsModel model ) => model.data.actorsData);
